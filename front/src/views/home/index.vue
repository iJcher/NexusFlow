  ...
  <div class="landing-page">
    ...
    <footer class="landing-footer">
      <div class="footer-inner">
        ...
        <div class="footer-links flex items-center justify-center gap-2">
          <a href="https://github.com/iJcher/NexusFlow" target="_blank" rel="noopener">GitHub</a>
...
.hero-brand-tagline {
  font-family: 'NanAnTi', sans-serif;
  font-size: 15px;
  font-weight: 400;
  color: #00d4aa;
  margin: 0;
